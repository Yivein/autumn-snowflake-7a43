...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/autumn-snowflake-7a43
```

A live public deployment of this template is available at [https://autumn-snowflake-7a43.templates.workers.dev](https://autumn-snowflake-7a43.templates.workers.dev)
